      ...
      <div className="max-w-4xl mx-auto bg-white rounded-3xl p-8 sm:p-12 shadow-xl border border-slate-200/80">
        ...
        <div className="space-y-8 text-slate-600 leading-relaxed text-sm sm:text-base">
          <section>
            ...
            <p>
              SpendTrack provides personal finance tracking, budget analysis, recurring subscription management, AI receipt processing, and Gemini AI insights integrated directly with your Google Workspace account.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              As a user of SpendTrack, you are responsible for maintaining the confidentiality of your Google account credentials, ensuring the accuracy of financial records you input, and securing access to devices used to run the application.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              By authorizing SpendTrack, you grant the application permission to create, update, and manage designated SpendTrack spreadsheets in Google Sheets, receipt folders in Google Drive, and bill reminder events in Google Calendar strictly to support requested application features.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              All financial data, spreadsheets, receipt uploads, and generated reports created using SpendTrack remain your exclusive property. SpendTrack claims no ownership over any content stored in your Google Workspace account.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              You may terminate your use of SpendTrack at any time by revoking the app's OAuth permissions via your Google Account Security Settings. Termination will immediately cease all bi-directional sync with your Google account.
            </p>
          </section>
