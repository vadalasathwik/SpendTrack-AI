...
export const FloatingDock: React.FC<FloatingDockProps> = ({
  ...
  return (
    <div className="fixed bottom-5 left-1/2 -translate-x-1/2 z-40 w-[92%] max-w-[410px] pointer-events-auto">
          ...
          if (item.isFab) {
            return (
              <button
                ...
                className="w-14 h-14 rounded-full bg-gradient-to-tr from-emerald-500 via-teal-500 to-cyan-500 text-white flex items-center justify-center shadow-lg shadow-emerald-500/30 hover:scale-105 active:scale-95 transition-all duration-200 ring-4 ring-emerald-500/20 -mt-6 shrink-0 cursor-pointer"
